...
void seperateThread(int clientSocketDescriptor,map<string,void(*)(Request &,Response &)> requestMappings )
{
FILE *f;
...
ThreadManager<void(*)(int,map<string,void(*)(Request &,Response &)>),int,map<string,void(*)(Request &,Response &)>> tm(seperateThread,clientSocketDescriptor,requestMappings);
